...
var MapsLib = {
  ...
  fusionTableId:      "1ISCmcNTUrQJ1Vi2zMmUuLxuw1P8dkO59WwKKw1U-", //Point data layer
  ...
  googleApiKey:       "AIzaSyCy4cNtfENpveN3UQmdwumU6c303DalO4c",
      ...
      styles: [
        {
          stylers: [
            ...
            { lightness: 10 }     // Current values make thematic polygon shading stand out over base map
          ]
        }
      ]
    };
  ...
  //-----custom filters for point data layer
    ...
    /* var type_column = "Precinctme";  // -- note use of single & double quotes for two-word column header
    var tempWhereClause = [];
   ...
   if ( $("#select_precinct").val() != "")
      whereClause += " AND 'Precinct' Like '"( + $("#select_precinct").val() + )"'";
  ...
  displayList: function(json) {
    ...
    if (rows == null) {
      ...
      // rows[row][5] = Url
      // rows[row][6] = Manager
      // rows[row][7] = Gain_numeric1q7msD-StNBYKANIYENFH5DpA6i8WHzzdrO9zE60f
