...
var MapsLib = {
  ...
  polygon1TableID:    "18mQEhLATeeYeZtkxY_2J71Yrc1YymHjqOWi1DiTU", //Outline map layer of CT town boundaries
  //polygon2TableID:    "1VopQGBhRKyyk25EIA5ptScvULxR68d43RhZ1ycM", //Thematic map layer of selected CT 
   districts

  //*MODIFY Fusion Tables Requirement* API key. found at https://code.google.com/apis/console/
  //*Important* this key is for demonstration purposes. please register your own.
  googleApiKey:       "AIzaSyAwwRhdqX4ZATPhGKWofTnBn3U8aLbbe9U",
  ...
  map_centroid:       new google.maps.LatLng(33.5550489565387, -83.8501865539764), //center that your map defaults to
  ...
  /*  var type_column = "'Weighted Prim D'";  // -- note use of single & double quotes for two-word column header
    var tempWhereClause = [];
    ...
    var type_column = "'Weighted Prim D'";
    var searchType = type_column + " IN (-1,";
    if ( $("#cbType1").is(':checked')) searchType += "12,";
    if ( $("#cbType2").is(':checked')) searchType += "11,";
    if ( $("#cbType3").is(':checked')) searchType += "10,";
  ...
  getList: function(whereClause) {
    ...
    var selectColumns = "FullName, FullAddress, Phone";
 ...
 //     for (var row in rows) {
//
//        var WeightedPrimD = "<a href='" + rows[row][5] + "'>" + rows[row][0] + "</a>";
//        var fulladdress = rows[row][2] + "<br />" + rows[row][3] + ", " + rows[row][4];
//
//        list_table += "\
//          <tr>\
//            <td>" + Weighted Prim D + "</td>\
//            <td>" + rows[row][1] + "</td>\
//            <td>" + fulladdress + "</td>\
//            <td>" + rows[row][6] + "</td>\
